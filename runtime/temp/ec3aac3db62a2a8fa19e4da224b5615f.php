<?php /*a:2:{s:55:"/data/www/csgx2/application/admin/view/income_index.php";i:1567151846;s:56:"/data/www/csgx2/application/admin/view/public_header.php";i:1564456502;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8"/>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        <select id="s_status" lay-verify="required" class="layui-select">
                            ...
                            <option value="<?php echo htmlentities($Model::INCOME_SHOP); ?>" >设备</option>
                            <option value="<?php echo htmlentities($Model::INCOME_AGENT); ?>" >推荐</option>
                            <option value="<?php echo htmlentities($Model::INCOME_PATNER); ?>" >合伙人</option>
                            <option value="<?php echo htmlentities($Model::INCOME_UNICOME); ?>" >联创</option>
                        </select>
                    </div>
    ...
    layui.use(['layer', 'form', 'table', 'util', 'admin', 'formSelects'], function () {
        ...
        var insTb = table.render({
            ...
            cols: [[
                ...
                {templet:function(d){
                    if(<?php echo htmlentities($Model::INCOME_SHOP); ?>===d.type) return '店铺';
                    if(<?php echo htmlentities($Model::INCOME_AGENT); ?>===d.type) return '推荐收入';
                    if(<?php echo htmlentities($Model::INCOME_PATNER); ?>===d.type) return '合伙人';
                    if(<?php echo htmlentities($Model::INCOME_UNICOME); ?>===d.type) return '联创';
                    return '未知';
                },title: '收入类别'},
        ...
        function showRebackModel( M ) {
            ...
            admin.open({
                ...
                success: function (layero, dIndex) {
                    ...
                    var url =   '<?php echo url('income/back'); ?>';
                    // 回显数据
                    if ( M ) {
