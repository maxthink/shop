<?php /*a:2:{s:56:"/data/www/csgx2/application/admin/view/devtype_index.php";i:1564456502;s:56:"/data/www/csgx2/application/admin/view/public_header.php";i:1564456502;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8"/>
...
<script>
    ...
    layui.use(['layer', 'form', 'table', 'util', 'admin', 'formSelects'], function () {
        ...
        var insTb = table.render({
            elem: '#userTable',
            url: '<?php echo url('devtype/index'); ?>',
        ...
        function showEditModel(M) {
            admin.open({
                ...
                success: function (layero, dIndex) {
                    ...
                    var url = M ? '<?php echo url('devtype/update'); ?>' : '<?php echo url('devtype/add'); ?>';
                    // 回显数据
                    if (M) {
        ...
        form.on('switch(ckState)', function (obj) {
            ...
            $.post('<?php echo url('devtype/lock'); ?>', {
                Id: obj.elem.value,
