<?php /*a:2:{s:53:"/data/www/csgx2/application/admin/view/store_edit.php";i:1564394054;s:56:"/data/www/csgx2/application/admin/view/public_header.php";i:1564456502;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8"/>
    ...
    <div class="wd-pd-tb10 layui-form" id="parent">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline" style="width:500px;">
                <input type="hidden" name="store_id" value="<?php echo htmlentities($Store['id']); ?>">
                <input type="text" name="store_name" lay-verify="required|font_len" class="layui-input" value="<?php echo htmlentities($Store['store_name']); ?>">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline" style="width:200px;">
                <input type="text" name="store_principal" lay-verify="required" class="layui-input" value="<?php echo htmlentities($Store['store_principal']); ?>">
            </div>
            <span class="wd-lh-36" style="color: red;font-size: 30px">*</span>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline" style="width:200px;">
                <input type="text" name="store_phone"  lay-verify="store_phone|required" class="layui-input" value="<?php echo htmlentities($Store['store_phone']); ?>">
            </div>
            <span class="wd-lh-36" style="color: red">*请填写11位联系电话，座机请添加区号</span>
        </div>
        <?php if(is_array($imeis) || $imeis instanceof \think\Collection || $imeis instanceof \think\Paginator): if( count($imeis)==0 ) : echo "" ;else: foreach($imeis as $k=>$vo): if($k == 0): ?>
        <div class="layui-form-item">
            <label class="layui-form-label">设备编号:</label>
            <div class="layui-input-inline" style="width:200px;">
                <input type="text" name="imei[]" lay-verify="imei_check|required" class="layui-input" value="<?php echo htmlentities($vo); ?>">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline" style="width:500px;">
                <input type="text" name="store_address" lay-verify="required|ft_len" class="layui-input" value="<?php echo htmlentities($Store['store_address']); ?>">
            </div>
            <span class="wd-lh-36" style="color: red;font-size: 30px">*</span>
        </div>
        ...
        <div class="layui-upload" style="margin-left: 30px">
            ...
            <blockquote class="layui-elem-quote layui-quote-nm" style="margin-top: 10px;">
                ...
                <div class="layui-upload-list" id="imgArrWrap">
                    <?php if(is_array($images) || $images instanceof \think\Collection || $images instanceof \think\Paginator): $k = 0; $__LIST__ = $images;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?>
                        <li style="display:inline-block;position:relative;margin-right:5px;">
                            <img src="<?php echo htmlentities($vo['img_url']); ?>" height="150" width="220">
                            <input type="hidden" name="p_img<?php echo htmlentities($k); ?>" value="<?php echo htmlentities($vo['img_url']); ?>"/>
                            <span class="delBtn" style="position:absolute;right:0;bottom:0;background-color:#ff6600;color:#fff;padding:2px 6px;cursor:pointer;" data-src="<?php echo htmlentities($vo['img_url']); ?>" data-index="<?php echo htmlentities($k); ?>">X</span>
                        </li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </div>
            </blockquote>
    ...
    layui.use(['form','layer','upload'], function() {
        ...
        form.on('submit(save)',function(data){
            if(isSub){
                isSub = false;
                if(i>=4){
                    $.post("<?php echo url('store/edit'); ?>",data.field,function(res){
                        if(res.status == 1){
                            layer.msg(res.msg);
                            setTimeout(function(){
