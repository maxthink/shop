<?php /*a:2:{s:56:"/data/www/csgx2/application/admin/view/setmeal_index.php";i:1565325371;s:56:"/data/www/csgx2/application/admin/view/public_header.php";i:1564456502;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8"/>
...
<script>
    ...
    layui.use(['layer', 'form', 'table', 'util', 'admin', 'formSelects'], function () {
        ...
        var insTb = table.render({
            elem: '#userTable',
            url: '<?php echo url('setmeal/index'); ?>',
        ...
        function showEditModel(M) {
            admin.open({
                ...
                success: function (layero, dIndex) {
                    ...
                    var url = M ? '<?php echo url('setmeal/update'); ?>' : '<?php echo url('setmeal/add'); ?>';
                    // 回显数据
                    if (M) {
        ...
        form.on('switch(ckState)', function (obj) {
            ...
            $.post('<?php echo url('setmeal/lock'); ?>', {
                Id: obj.elem.value,
