<?php /*a:2:{s:55:"/data/www/csgx2/application/admin/view/device_index.php";i:1566990717;s:56:"/data/www/csgx2/application/admin/view/public_header.php";i:1564456502;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8"/>
...
<script>
    ...
    layui.use(['layer', 'form', 'table', 'util', 'admin', 'formSelects'], function () {
        ...
        function showEditModel(M) {
            admin.open({
                ...
                success: function (layero, dIndex) {
                    ...
                    var url = M ? "<?php echo url('device/update'); ?>" : "<?php echo url('device/add'); ?>";
                    // 回显数据
        ...
        function showQrcode(devId){
            ...
            //todo 定义路径
            var url = "<?php echo url('wx_dev_work','id',''); ?>/"+devId;
            //todo 显示二维码
            $('#devqrcode').qrcode({
