<?php /*a:2:{s:53:"/data/www/csgx2/application/admin/view/bill_index.php";i:1567151846;s:56:"/data/www/csgx2/application/admin/view/public_header.php";i:1564456502;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8"/>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        <select id="s_status" lay-verify="required" class="layui-select">
                            ...
                            <option value="<?php echo htmlentities($Mbill::PAY_NO); ?>" >未支付</option>
                            <option value="<?php echo htmlentities($Mbill::PAY_OK); ?>" >已支付</option>
                            <option value="<?php echo htmlentities($Mbill::PAY_BACK); ?>" >申请退款</option>
                            <option value="<?php echo htmlentities($Mbill::PAY_BACKOK); ?>" >已退款</option>
                        </select>
                    </div>
    ...
    layui.use(['layer', 'form', 'table', 'util', 'admin', 'formSelects'], function () {
        ...
        var insTb = table.render({
            ...
            cols: [[
                ...
                {templet:function(d){
                    if(<?php echo htmlentities($Mbill::PAY_NO); ?>===d.status) return '未支付';
                    if(<?php echo htmlentities($Mbill::PAY_OK); ?>===d.status) return '已支付';
                    if(<?php echo htmlentities($Mbill::PAY_BACK); ?>===d.status) return '申请退款';
                    if(<?php echo htmlentities($Mbill::PAY_BACKOK); ?>===d.status) return '已退款';
                    return '未知';
                },title: '订单状态'},
