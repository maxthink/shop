<?php /*a:2:{s:53:"/data/www/csgx2/application/admin/view/menu_index.php";i:1564456502;s:56:"/data/www/csgx2/application/admin/view/public_header.php";i:1564456502;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8"/>
        ...
        function showEditModel(objdata) {
            admin.open({
                ...
                success: function (layero, dIndex) {
                    ...
                    var url = objdata ? '<?php echo url('menu/update'); ?>' : '<?php echo url('menu/add'); ?>';
