<?php /*a:1:{s:51:"/data/www/csgx2/application/wx/view/manage_cash.php";i:1567061644;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<title>提现</title>
...
$(function(){
    ...
    $('.account').on('click', function(){
        ...
        $.get("<?php echo url('manage/account_list'); ?>",function(e){
            if(0===e.code){
    ...
    function pullAccount(){
        ...
        //提交新账户信息
        $.ajax({
            url:"<?php echo url('manage/account_update'); ?>",
            type:"post",
            data:formData,
            success: function(e){
                if(e.code===0){
