<?php /*a:1:{s:54:"/data/www/csgx2/application/wx/view/device1_record.php";i:1561520074;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<body>
    ...
    <div id="nav">
        <a href="<?php echo url('wx_dev_work','id',''); ?>/<?php echo htmlentities($dev['id']); ?>"><span>首页</span> </a>
...
<script>
    ...
    {
        $.post(
            '<?php echo url('device/run'); ?>',
            { reid:reid, curdevid:<?php echo htmlentities($dev['id']); ?> },
            function(res){
                if(res.code === 0){
                    //alert(res.msg);
