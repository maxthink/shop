<?php /*a:2:{s:54:"/data/www/csgx2/application/admin/view/admin_index.php";i:1565767102;s:56:"/data/www/csgx2/application/admin/view/public_header.php";i:1564456502;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8"/>
    ...
    layui.use(['layer', 'form', 'table', 'util', 'admin', 'formSelects'], function () {
        ...
        function showEditModel(mUser) {
            admin.open({
                ...
                success: function (layero, dIndex) {
                    ...
                    var url = mUser ? '<?php echo url('admin/update'); ?>' : '<?php echo url('admin/add'); ?>';
                    // 回显数据
        ...
        function resetPsw(userId, nickName) {
            top.layer.confirm('确定要重置“' + nickName + '”的登录密码吗？', {
                ...
                top.layer.close(i);
                layer.load(2);
                $.post('<?php echo url('admin/resetpasswd'); ?>', {
                    userId: userId
                }, function (res) {
                    layer.closeAll('loading');
                    if (res.code == 0) {
