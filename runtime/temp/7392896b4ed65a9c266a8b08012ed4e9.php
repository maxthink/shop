<?php /*a:2:{s:53:"/data/www/csgx2/application/admin/view/shop_index.php";i:1562230798;s:56:"/data/www/csgx2/application/admin/view/public_header.php";i:1564456502;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8"/>
...
<div class="layui-fluid">
    <div class="layui-row layui-col-space10">
        <div class="layui-col-sm4 layui-col-md6 layui-col-lg2">
            <!-- 填充内容 -->
            <div class="layui-card">
                <div class="layui-card-header">
                    <a lay-href="#" class="layui-a-tips">十里街美容院</a>
                </div>
                <div class="layui-card-body">
                    <form class="layui-form" action="" lay-filter="component-form-element">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="checkbox" name="interest[write]" title="wifi"><div class="layui-unselect layui-form-checkbox"><span>写作</span><i class="layui-icon layui-icon-ok"></i></div>
                                <input type="checkbox" name="interest[read]" title="空调"><div class="layui-unselect layui-form-checkbox"><span>阅读</span><i class="layui-icon layui-icon-ok"></i></div>
                                <input type="checkbox" name="interest[code]" title="移动" checked=""><div class="layui-unselect layui-form-checkbox layui-form-checked"><span>代码</span><i class="layui-icon layui-icon-ok"></i></div>
                                <input type="checkbox" name="interest[dreaming]" title="蓝牙"><div class="layui-unselect layui-form-checkbox"><span>做梦</span><i class="layui-icon layui-icon-ok"></i></div>
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">位置坐标：</label>
                            <div class="layui-input-block">
    ...
    <script>
        ...
        type: 1,
                ...
                var url = '<?php echo url('bill / back'); ?>';
                // 回显数据
                if (M) {
