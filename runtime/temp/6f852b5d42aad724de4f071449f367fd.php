<?php /*a:1:{s:54:"/data/www/csgx2/application/admin/view/index_index.php";i:1563516047;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8"/>
        ...
        <ul class="layui-nav layui-layout-right">
            ...
            <li class="layui-nav-item" lay-unselect>
                ...
                <dl class="layui-nav-child">
                    <dd lay-unselect>
                        <a tw-href="<?php echo url('personal/index'); ?>">个人中心</a>
                    </dd>
                    <dd lay-unselect>
                        <a tw-event="psw" data-url="<?php echo url('admin/updatepasswd'); ?>" >修改密码</a>
                    </dd>
                    <hr>
                    <dd lay-unselect>
                        <a tw-event="logout" data-url="<?php echo url('login/logout'); ?>">退出</a>
                    </dd>
                </dl>
            </li>
...
<script>
    layui.use(['index','layer'], function () {
        ...
        // 默认加载主页
        index.loadHome({
            menuPath: '<?php echo url('dashboard/welcome'); ?>',
